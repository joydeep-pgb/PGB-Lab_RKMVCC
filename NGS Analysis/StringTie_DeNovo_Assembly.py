...
output_dir = "/mnt/WD_Blue/Sorghum/TEST/DeNovo_Assembled/"

# Define the path to the reference annotation GTF file
reference_gtf = "/mnt/WD_Blue/Sorghum/TEST/annotation_sbi.gff3"
...
for bam_file in bam_files:
    ...
    stringtie_cmd = f"stringtie -p 8 -G {reference_gtf} -o {output_gtf} {input_bam} -f 0.01 -m 200 -a 10 -j 1 -c 1 -g 50 -M 1.0"
    subprocess.run(stringtie_cmd, shell=True)

    print(f"Assembled: {sample_name}")

print("DeNovo Assembly complete.")
