...
# --------------------------------------------------
# Detect Single-End FASTQ files
# --------------------------------------------------
fastq_files = sorted(
    f for f in os.listdir(input_dir) if f.endswith(".fastq.gz")
)
...
for fastq in fastq_files:
    ...
    fq = os.path.join(input_dir, fastq)
    ...
    # --------------------------------------------------
    # STAR command (Single-End, circRNA-optimized)
    # --------------------------------------------------
    star_cmd = [
        "STAR",
        "--runThreadN", "10",
...
print("[DONE] STAR mapping, sorting, and indexing completed (Single-End).")
